...
<div class="container pt-3">
      <div class="row mb-3">
         <div class="col-sm-8">   <h4 class="">Find Owners</h4></div>
         </div>
        <div class="input-group flex-nowrap">
        <span>Lastname</span> &nbsp; &nbsp;
          <input type="text" class="form-control" style="width: 70%">           
</div> 
          <button type="submit" class="btn btn-secondary" style="margin: 15px;" value="search">Find owner</button>

 </div>
 <button type="button" class="btn btn-secondary" style="margin: 10px;"><a href="/editO" style="color: white; text-decoration: none;">Add Owner</a></button>
